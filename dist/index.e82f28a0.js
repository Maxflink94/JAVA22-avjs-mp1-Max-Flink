...
window.onload = function() {
    (0, _highscore.showHighscoreList)(highscoreDiv);
};
function isGameDivHidden(isHidden) {
    if (isHidden) gameDiv.style.display = "none";
    else gameDiv.style.display = "block";
}
function isWelcomeDivHidden(isHidden) {
    if (isHidden) welcomeDiv.style.display = "none";
    else welcomeDiv.style.display = "block";
}
function isWinnerDivHidden(isHidden) {
    if (isHidden) winnerDiv.style.display = "none";
    else winnerDiv.style.display = "block";
}
...
function setWinnerHeadline() {
    if (computerScore >= 1) winnerHeadline.innerText = "The Computer beat you...";
}
// Datorns val
...
},{"./highscore":"1RvGA"}],"1RvGA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Hämtar highscore från firebase
parcelHelpers.export(exports, "getHighscoreList", ()=>getHighscoreList);
parcelHelpers.export(exports, "addPossHighscore", ()=>addPossHighscore);
parcelHelpers.export(exports, "showHighscoreList", ()=>showHighscoreList);
...
async function addPossHighscore(newAttempt) {
...
async function showHighscoreList(div) {
    const highscoreList = await getHighscoreList();
...
},{}]},["fyTPu","dV6cC"], "dV6cC", "parcelRequire8de9")
